 ...
 */
public class ConditionalStatement extends Construction implements ConstructionContainer, ConstructionGenerator {
    ...
    public List<Construction> getConstructions(Context context) {
        List<Construction> constructions = CollectionFactory.newArrayList(Construction.class);
