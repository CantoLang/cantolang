...
public class ComplexType extends AbstractType implements Initializable {
    ...
    public void resolve() {
        ...
        LOG.debug("Resolving type " + checkName + " in " + owner.getFullName() + "...");
        Definition def = null;
        ...
        if (def != null) {
            ...
            if (def.getAccess() == Definition.Access.LOCAL) {
                LOG.debug("   ...type " + checkName + " refers to local definition " + def.getFullName());
            } else if (checkName.equals(def.getFullName())) {
                LOG.debug("   ...type " + checkName + " is an explicit definition reference");
            } else {
    ...
    public Value convert(Value val) {
        ...
        try {
            ...
            LOG.debug("Error converting value to " + getName() + ": " + r.getMessage());
        }
        return result;
    }
