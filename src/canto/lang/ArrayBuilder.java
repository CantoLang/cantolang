...
public class ArrayBuilder extends CollectionBuilder {
    private static final Log LOG = Log.getLogger(ArrayBuilder.class);
...
class ArrayInstance implements CantoArray, DynamicObject {
    private static final Log LOG = Log.getLogger(ArrayInstance.class);
    ...
    private void init_array() {
        if (data == null) {
            LOG.debug("data for array instance is null; initializing to empty array");
