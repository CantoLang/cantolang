...
public class Utils {
    private static final Log LOG = Log.getLogger(Utils.class);
    ...
    public static String getenv(String varname) {
        ...
        try {
            ...
            LOG.info("Unable to get environment variable " + varname + ": " + t.toString());
        }
    ...
    public static void deserialize(Context context, Definition def, String str, Object[] field_names, Object[] field_values) throws Redirection {
        Scope scope = def.getScopeInContext(context);
        while (scope != null && scope.def.equalsOrExtends(def)) {
        ...
        Map<String, Object> cache = scope.getKeep();
            ...
            if (obj instanceof TableElement) {
                ...
                if (contents instanceof CollectionDefinition) {
                    ...
                    if (collectionDef.isArray()) {
                        ...
                        if (childDef != null && !childDef.isTable()) {
    ...
    private static void handleArray(Context context, Map<String, Object> cache, Definition ownerDef, String key, CantoArray array) throws Redirection {
        ...
        for (int i = 0; i < size && it.hasNext(); i++) {
            Object item = it.next();
            if (item instanceof ResolvedTable && itemDef != null && !itemDef.isTable()) {
                Map<String, Object> subcache = Context.newHashMap(Object.class);
