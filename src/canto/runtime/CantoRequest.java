...
public class CantoRequest {

    private Request request = null;
    private CantoSession session = null;
    private Map<String, String> paramMap = null;

    public CantoRequest(Request request) {
        this.request = request;
    }

    public CantoRequest(CantoSession session, Map<String, String> requestParams) {
    ...
    public CantoSession getSession() {
        if (session == null) {
            session = new CantoSession(request.getSession(false));
        }
        return session;
    }
    ...
    public class SingleEntryMap implements Map<String, String> {
        ...
        public void putAll(Map<? extends String, ? extends String> t) {
            throw new UnsupportedOperationException("CantoRequest param map does not support putAll()");
        }
